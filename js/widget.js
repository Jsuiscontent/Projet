...
class LaFourchetteController extends WidgetController {
  ...
  do_something(position.coords.latitude, position.coords.longitude);
	...
	async load() {
		...
		let article = new xph().doc(dom).ctx(dom).craft('//*[@id="mostBookedPanel"]/div[1]/ul[1]/li[1]').firstResult; // find interesting things
		let article2 = new xph().doc(dom).ctx(dom).craft('//*[@id="mostBookedPanel"]/div[1]/ul[1]/li[1]/div[2]/a[1]').secondResult; // find interesting things
