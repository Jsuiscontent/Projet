...
class WidgetView extends Try {
	...
	draw() {
		...
		if(this.try.mvc.main.header) {
			...
			SS.style(this.try.header, {"z-index": 100, "userSelect": "none", "width": "100%", "height": "25px", "lineHeight": "25px", "textAlign": "center", "border-top-left-radius": this.try.mvc.main.radius + "px", "border-top-right-radius": this.try.mvc.main.radius + "px","backgroundColor": "#33FF66"});
		...
		if(this.try.mvc.main.footer) {
			...
			SS.style(this.try.footer, {"position": "absolute", "bottom": "0px", "z-index": 100, "width": "100%", "height": "25px", "lineHeight": "25px", "textAlign": "center", "border-bottom-left-radius": this.try.mvc.main.radius + "px", "border-bottom-right-radius": this.try.mvc.main.radius + "px","backgroundColor": "#33FF66"});
